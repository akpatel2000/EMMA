...
q1 <- sapply(split(r1, r1$emmaReportedDateTimeStamp), nrow)
q1 <- log10(q1)
...
boxplot(emmaTradeYield ~ emmaReportedDateTimeStamp, data = r1, col = "grey", ylab = "Yield")
abline(h=emmaInitialOfferYield, col = "blue")

f1 <- filter(r1, emmaReportedDateTimeStamp == r1$emmaReportedDateTimeStamp[1])
